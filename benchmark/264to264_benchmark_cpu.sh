...
#
# Usage:    bash 264to264_benchmark_cpu.sh <batch size> <transcoding bitrate> <s3 bucket name> <filename>
#
...
#
# Sample:   bash 264to264_benchmark_cpu.sh 5 2.5M ffmpeg-on-graviton-ap-northeast-1 bbb_sunflower_1080p_30fps_normal.mp4
#
